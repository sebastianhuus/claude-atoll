...
final class ReleaseService {
    ...
    nonisolated private static let logger = Logger(subsystem: "com.engels74.ClaudeAtoll", category: "ReleaseService")

    private static let releasesURL = "https://api.github.com/repos/engels74/claude-atoll/releases"
    ...
    private static var cacheDirectoryURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first
            .map { $0.appendingPathComponent("com.engels74.ClaudeAtoll") }
    }
