...
final class AccessibilityPermissionManager {
    ...
    func showPermissionAlert() -> Bool {
        ...
        Claude Atoll needs Accessibility permission to:
        ...
        3. Navigate to and select the Claude Atoll app bundle
        4. Enable the checkbox next to Claude Atoll

        Important: If Claude Atoll is already in the list but not working, \
    ...
    nonisolated private static let logger = Logger(subsystem: "com.engels74.ClaudeAtoll", category: "AccessibilityPermission")
