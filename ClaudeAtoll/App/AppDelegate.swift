...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    nonisolated private static let logger = Logger(subsystem: "com.engels74.ClaudeAtoll", category: "AppDelegate")
    ...
    private func ensureSingleInstance() -> Bool {
        let bundleID = Bundle.main.bundleIdentifier ?? "com.engels74.ClaudeAtoll"
